...
const SEQUENCE_MESSAGES = [
    ...
    { 
        type: 'sequence', 
        text: '[BALTASAR-ROT11] Эыпэуф мщцам ъыушрь ъыушбпььп хщыщцпмьхюи чкшэуи, тшкй вэщ эщф шухщнок шп ьэкэж хщыщцпмщф. Шщ хщыщци экх у шп юощьюсуцщьж шкопэж зэю чкшэуи шк ьмщи ощвж /n GT W S',
        key: 3
    }
];
